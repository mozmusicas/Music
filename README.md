...
1. Extrair **todo** o conteúdo desta pasta na **raiz** do repositório `musicas` (ou no branch `gh-pages`).
2. Tem de existir na raiz:
   - `index.html`
   - `css/style.css`
   - `js/` (app.js, player.js, …)
   - `data/` (*.json)
   - `assets/images/albums/`
3. Se só enviares os HTML sem a pasta `css/`, o site fica branco (HTML sem estilo).
4. Site: https://musicas.github.io/
